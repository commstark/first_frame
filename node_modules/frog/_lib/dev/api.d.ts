...
export declare function apiRoutes(options: ApiRoutesOptions & {
...
}, import("hono").ToSchema<"get", "/frames", unknown, string[]> & import("hono").ToSchema<"get", "/frames/:url", unknown, {
    readonly id: string;
    ...
    readonly url: string;
}> & import("hono").ToSchema<"post", "/frames/:url/action", {
    json: {
    ...
    readonly url: string;
}> & import("hono").ToSchema<"post", "/frames/:url/redirect", {
    json: {
        readonly buttonIndex: number;
        readonly transactionId: string | undefined;
        readonly fid: number;
    ...
    readonly sourceFrameId: string;
    readonly url: string;
}> & import("hono").ToSchema<"post", "/frames/:url/tx", {
    json: {
        readonly buttonIndex: number;
        readonly transactionId: string | undefined;
        readonly fid: number;
    ...
    readonly sourceFrameId: string;
    readonly url: string;
}> & import("hono").ToSchema<"get", "/auth/code", unknown, {
    token: string;
    url: string;
}> & import("hono").ToSchema<"get", "/auth/status/:token", unknown, {
    displayName?: string | undefined;
    pfp?: string | undefined;
    state: "completed";
    token: string;
...
}> & import("hono").ToSchema<"post", "/auth/logout", unknown, {
    success: boolean;
}> & import("hono").ToSchema<"post", "/debug/image/:url", {
    json: {};
}, {}>, "/">;
export type ApiRoutes = ReturnType<typeof apiRoutes>;
type Client = ReturnType<typeof hc<ApiRoutes>>;
export type Data = InferResponseType<Client['frames'][':url']['$get']> | InferResponseType<Client['frames'][':url']['action']['$post']> | (InferResponseType<Client['frames'][':url']['redirect']['$post']> & BaseData) | (InferResponseType<Client['frames'][':url']['tx']['$post']> & BaseData);

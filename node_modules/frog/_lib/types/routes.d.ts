...
import type { CastActionContext, Context, FrameContext, ImageContext, TransactionContext } from './context.js';
...
export type H<E extends Env = any, P extends string = any, I extends Input = BlankInput, R extends HandlerResponse<any> = any, M extends string = string> = M extends 'frame' ? FrameHandler<E, P, I> : M extends 'transaction' ? TransactionHandler<E, P, I> : M extends 'castAction' ? CastActionHandler<E, P, I> : M extends 'image' ? ImageHandler<E, P, I> : Handler<E, P, I, R>;

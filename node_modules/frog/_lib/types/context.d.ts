...
export type CastActionContext<env extends Env = Env, path extends string = string, input extends Input = {}> = {
    /**
...
export type Context<env extends Env = Env, path extends string = string, input extends Input = {}, _state = env['State']> = {
    /**
...
export type FrameContext<env extends Env = Env, path extends string = string, input extends Input = {}, _state = env['State']> = Context<env, path, input, _state> & {
    /**
...
export type TransactionContext<env extends Env = Env, path extends string = string, input extends Input = {}, _state = env['State']> = Context<env, path, input, _state> & {
    /**
...
export type ImageContext<env extends Env = Env, path extends string = string, input extends Input = {}> = {
    /**
     * `.env` can get bindings (environment variables, secrets, KV namespaces, D1 database, R2 bucket etc.) in Cloudflare Workers.
     *
     * @example

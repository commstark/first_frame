...
export declare function Text<vars extends Vars>({ __context, align, children, color, decoration, font, overflow, shadow, style, size, tracking, transform, weight, wrap, }: TextProps<vars>): JSX.Element;

 ...
 * ```
 */
export declare class Frog<env extends Env = Env, schema extends Schema = {}, basePath extends string = '/', _state = env['State']> extends FrogBase<env, schema, basePath, _state> {
